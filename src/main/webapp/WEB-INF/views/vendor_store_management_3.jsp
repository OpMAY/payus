        ...
        <div class="page-content d-flex align-items-center justify-content-center" style="flex-direction: column">
            <div class="payus-modal">
                <div class="modal-body">
                    ...
                    <div class="row row-cols-2 row-cols-xl-4 row-cols-lg-2 row-cols-md-2 row-cols-sm-2"
                         style="margin-top: 2rem">
                        <div class="col payus-modal-textarea-form">
                            <label for="review-writer">작성자</label>
                            <textarea class="payus-modal-textarea" id="review-writer" rows="1" disabled>리뷰 내용</textarea>
                        </div>
                        <div class="col payus-modal-textarea-form">
                            <label for="review-rate">별점</label>
                            <textarea class="payus-modal-textarea" id="review-rate" rows="1" disabled>4</textarea>
                        </div>
                        <div class="col payus-modal-textarea-form">
                            <label for="review-reg-date">생성 일자</label>
                            <textarea class="payus-modal-textarea" id="review-reg-date" rows="1"
                                      disabled>2021.01.12</textarea>
                        </div>
                        <div class="col payus-modal-textarea-form">
                            <label for="review-answer-status">답변 여부</label>
                            <textarea class="payus-modal-textarea" id="review-answer-status" rows="1"
                                      disabled>답변 완료</textarea>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 1rem">
                        <div class="col-12">
                            <label for="review-content">리뷰 내용</label>
                            <textarea class="payus-modal-textarea" id="review-content" rows="5" disabled>리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용리뷰내용</textarea>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 1rem">
                        <div class="col-12">
                            <label for="review-images">리뷰 이미지</label>
                            <div class="row row-cols-5" id="review-images">
                                <div class="col modal-image-div">
                                    <div class="img-container">
                                        <img src="https://payus.s3.ap-northeast-2.amazonaws.com/api/test/sample_hotel_img_2.jpg" alt style="width: 100%; height: 100px; object-fit: fill">
                                    </div>
                                </div>
                                <div class="col modal-image-div">
                                    <div class="img-container">
            ...
            <div class="row" style="width: 100%; margin-top: 3rem">
                ...
                <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-12"
                    ...
                    <div class="row" style="justify-content: right; margin-bottom: 1rem; padding: 0 16px">
...
<script>
    ...
    $(".btn-payus-table").on("click", function () {
        let review_no = $(this).parent().parent().attr('review');
        console.log(review_no);
        // TODO 해당 review_no로 리뷰 상세 내용 보여주는 모달
