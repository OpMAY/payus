                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <div class="forms-sample noto-font">
                                    <div class="col-12">
...
<script>
    ...
    function changePassword() {
        ...
        let data = {"password": newPW};
        $.ajax({
            type: 'POST',
            url: '/vendor/mypage/password/change',
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            data: JSON.stringify(data)
        }).done(function (result) {
            if (result === 0) {
                alert("비밀번호 변경이 완료되었습니다.\n보안을 위해 다시 로그인 해주시길 바랍니다.");
                window.location.replace("/vendor/login.do");
            } else if (result === 1) {
