...
public class EmailSendService {
    ...
    public String sendEmailForValidation(String toMail) {
        ...
        String content = System.getProperty("line.separator") + "안녕하세요. 공급자님" + System.getProperty("line.separator") + "PayUs 공급자 비밀번호 찾기 인증번호는 " + validationCode + "입니다." + System.getProperty("line.separator");
